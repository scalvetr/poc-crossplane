...
sed -i.bak "s/provider-poc/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/provider-poc" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/provider-poc-controller" "cluster/images/provider-${ProviderNameLower}-controller"
